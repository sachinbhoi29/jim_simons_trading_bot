# #! this is incorrect as we are using future info to predict past and it shpould ajve been vice versaa
# import os
# import pandas as pd
# import numpy as np
...
#     tickers = LARGE_CAP_TICKERS + MID_CAP_TICKERS #["ABB.NS"] # at least 2 tickers
#     aiml_pipeline.generate_stock_features(tickers, start="2024-01-02",end="2025-11-21",add_index=True,show=False)
