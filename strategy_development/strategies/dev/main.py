...
if __name__ == '__main__':
    ...
    tickers =  SMALL_CAP_TICKERS + LARGE_CAP_TICKERS + MID_CAP_TICKERS # SMALL_CAP_TICKERS #+LARGE_CAP_TICKERS + MID_CAP_TICKERS #["ABB.NS"] # at least 2 tickers
    # end date should be date + 1 day 
    aiml_pipeline.generate_stock_features(tickers, start="2012-01-02",end="2013-12-31",add_index=True,show=False,lookback=5, tp_pct=0.02, sl_pct=0.01)
