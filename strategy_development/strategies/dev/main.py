...
if __name__ == '__main__':
    ...
    aiml_pipeline = AIMLFeaturePipelineV2(future_return=1,real_prediction=True)
    ...
    aiml_pipeline.generate_stock_features(tickers, start="2025-05-02",end="2025-11-28",add_index=True,show=False,lookback=5, tp_pct=0.02, sl_pct=0.01)
