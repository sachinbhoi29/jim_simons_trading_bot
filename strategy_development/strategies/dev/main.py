...
if __name__ == '__main__':
    ...
    aiml_pipeline = AIMLFeaturePipeline(future_return=3)
    ...
    aiml_pipeline.generate_stock_features(tickers, start="2017-01-02",end="2025-11-15",add_index=True,show=False)
