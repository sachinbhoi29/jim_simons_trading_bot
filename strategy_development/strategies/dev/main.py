...
if __name__ == '__main__':
    ...
    aiml_pipeline = AIMLFeaturePipelineV2(future_return=1)
    ...
    aiml_pipeline.generate_stock_features(tickers, start="2014-01-02",end="2024-12-21",add_index=True,show=False,lookback=5, tp_pct=0.02, sl_pct=0.01)
