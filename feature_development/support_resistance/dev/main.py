...
if __name__ == "__main__":
    ...
    # df = yf.download(ticker,start="2024-01-01",end="2025-05-01",interval="1d",auto_adjust=False,multi_level_index=False)
    ...
    zigzag = ZigzagSR(min_peak_distance=8, min_peak_prominence=10, zone_merge_tolerance=0.007, max_zones=8, color_zone="green", alpha_zone=0.2, show=True,show_fibo = False,show_trendline=False,show_only_latest_fibo=True)
