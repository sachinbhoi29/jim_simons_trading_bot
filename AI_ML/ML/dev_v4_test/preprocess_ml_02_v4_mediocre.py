...
if __name__ == "__main__":
    SCALER_PICKLE = "C:/PERSONAL_DATA/Startups/Stocks/Jim_Simons_Trading_Strategy/AI_ML/ML/dev_v4_test/data/scaler_v4.pkl"

    input_path = (
        "C:/PERSONAL_DATA/Startups/Stocks/"
        "Jim_Simons_Trading_Strategy/AI_ML/ML/dev_v4_test/data/features_ready.csv"
    )

    output_path = (
        "C:/PERSONAL_DATA/Startups/Stocks/"
        "Jim_Simons_Trading_Strategy/AI_ML/ML/dev_v4_test/data/normalized_data_for_ml.csv"
    )
